...
*/
const TOKEN = "pk.eyJ1IjoibWljaGVsbGVsaW5nIiwiYSI6ImNqbTd4dWljdTAxYzgzcHA5MWxleXFtdm8ifQ.P2GsSzMgTFCldnFfcwnlGQ";
var locations = [];
...
for (i = 0; i < locations.length; i++) {
    var feature = {
        "type": "Feature",
        "properties": {
            "description": "<b>" + locations[i].name + "</b> <br />" + locations[i].description,
